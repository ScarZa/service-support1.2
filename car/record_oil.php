...
<?php function edit_date($take_date) {
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body" align='center'>
                <b>รถยนต์หมายเลขทะเบียน <?= $lp['license_name'];?></b><br>
                        ...
                        <thead>
                            <tr><?php if(!empty($_GET['edit_oil'])){
 			$take_date= $detial_oil['reg_date'];
                        }else{
 		...
 		?>
                ...
                //$( "#datepicker2" ).datepicker("setDate", new Date('<?=$take_date2?>')); //Set ค่าวัน
                  ...
                  <td colspan="3">&nbsp;&nbsp;<input type="text" class="" id="datepicker" name="reg_date" value="<?=edit_date($take_date)?>" required=""></td>
              </tr>
              <tr>

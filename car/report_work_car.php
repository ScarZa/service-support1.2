...
<div class="table-responsive">
                ...
                <table  id="datatable"  align="center" width="100%" class="table table-responsive table-bordered table-hover">
                    ...
                    <tr align="center">
                        <td colspan="13"><b>ปีงบประมาณ <?= isset($years)?$years:''?>  ประจำเดือน <?= isset($month['month_name'])?$month['month_name']:''?></b></td>
                    </tr>
                    <tr align="center" >
                    ...
                    <?php 
                    $info[0]= isset($info[0])?$info[0]+$result['count_in_province']:'';
                    $info[1]= isset($info[1])?$info[1]+$result['sum_in_province']:'';
                    $info[2]= isset($info[2])?$info[2]+$result['count_out_province']:'';
                    $info[3]= isset($info[3])?$info[3]+$result['sum_out_province']:'';
                    $info[4]= isset($info[4])?$info[4]+$result['sum_distance']:'';
                    $info[5]= isset($info[5])?$info[5]+$result['oil_bill']:'';
                    $info[6]= isset($info[6])?$info[6]+$result['bath_bill']:'';
                    $info[7]= isset($info[7])?$info[7]+$result['oil']:'';
                    $info[8]= isset($info[8])?$info[8]+$result['bath']:'';
                    $info[9]= isset($info[9])?$info[9]+$result['av']:'';
                    $info[10]= isset($info[10])?$info[10]+$result['maintenance']:'';
                    $i++;

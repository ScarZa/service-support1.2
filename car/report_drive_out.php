...
GROUP BY d.depId ORDER BY dist DESC";
    $qr = mysqli_query($db,$q);
                ...
                <table  id="datatable"  align="center" width="100%" border="" class="table table-responsive table-bordered table-hover">
                    ...
                    <tr align="center">
                        <td colspan="4"><b>ประจำปีงบประมาณ <?= isset($years)?$years:''?> เดือน  <?= isset($month['month_name'])?$month['month_name']:''?></b></td>
                    </tr>
                    <tr align="center">
                        <td colspan="4"><b>รถยนต์หมายเลขทะเบียน <?= isset($license_plate['license_name'])?$license_plate['license_name']:''?> </b></td>
                    </tr>
                    <tr align="center" >
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td align="center"><?= isset($sumtime)?$sumtime:''?></td>
                            <td align="center"><?= isset($sumdist)?$sumdist:''?></td>
                        </tr>
                    </tfoot>
                </table>
                </div>

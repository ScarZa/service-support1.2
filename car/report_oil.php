...
<div class="row">
    ...
    $sumbill=  mysqli_fetch_assoc($sql_bill);
                ...
                <table  id="datatable"  align="center" width="100%" class="table table-responsive table-bordered table-hover">
                    ...
                    <tr align="center">
                        <td colspan="11"><b>ประจำปีงบประมาณ <?= isset($years)?$years:''?> เดือน  <?= isset($month['month_name'])?$month['month_name']:''?></b></td>
                    </tr>
                    <tr align="center">
                        <td colspan="11"><b>รถยนต์หมายเลขทะเบียน <?= isset($license_plate['license_name'])?$license_plate['license_name']:''?> เกณฑ์การใช้น้ำมัน............................... กม./ลิตร</b></td>
                    </tr>
                    <tr align="center" >
                ...
                ?>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td align="center"><?= isset($sumdistance)?$sumdistance:''?></td>
                            <td align="center"><?= isset($sumoil)?$sumoil:''?></td>
                            <td align="center"><?= isset($sumbath)?$sumbath:''?></td>
                            <td align="center"></td>
                            <td align="center"><?php if(!empty($distance)){ echo round($sumdistance/$sumoil,2);}?></td>
                            <td align="center"><?= isset($summaintenance)?$summaintenance:''?></td>
                            <td align="center"></td>
                        </tr>
                        <tr>
                            <td align="center" colspan="4" bgcolor="#898888"><b>เงินสด</b></td>
                            <td align="center"></td>
                            <td align="center"><?= isset($sumcash['sumliter'])?$sumcash['sumliter']:''?></td>
                            <td align="center"><?= isset($sumcash['sumbath'])?$sumcash['sumbath']:''?></td>
                            <td align="center" colspan="4"></td>
                        </tr>
                        <tr>
                            <td align="center" colspan="4" bgcolor="#898888"><b>บิลน้ำมัน</b></td>
                            <td align="center"></td>
                            <td align="center"><?= isset($sumbill['sumliter'])?$sumbill['sumliter']:''?></td>
                            <td align="center"><?= isset($sumbill['sumbath'])?$sumbill['sumbath']:''?></td>
                            <td align="center" colspan="4"></td>
                        </tr>
                    </tfoot>
                </table>

...
WHERE ssc.car_id ='$car_id'");
          ...
          if($result['empno']==$edit_person['rider']){$selected='selected';}else{$selected='';}
              ...
              <?php }?>
              <?php if($method=='mile_car' or $method=='edit_mile_car'){ ?>
              <tr>
              ...
              <?php }?>
                ...
                <?php if($method=='back'){
                    ...
                    ?>
                <a href="../fullcalendar/fullcalendar2.php"><img src="../images/undo.ico" width="20"  title="ย้อนกลับ"> กลับไปปฏิทิน</a>
                <?php }?>
        </div>
            </div>
            </div>

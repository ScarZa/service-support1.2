...
function page_navigator($before_p,$plus_p,$total,$total_p,$chk_page){   
 ...
 $Search_fname= isset($_SESSION['Search_fname'])?$_SESSION['Search_fname']:'';
 $Search_lname= isset($_SESSION['Search_lname'])?$_SESSION['Search_lname']:'';
 if(!empty($Search_fname) || !empty($Search_lname)){
